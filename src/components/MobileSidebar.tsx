...
import { Home, Users, Ticket, Wifi, FileText, Menu, Star, Tag, BookOpen, ShoppingCart, ClipboardList, X } from "lucide-react"
...
export function MobileSidebar({ dbUser, pendingOrdersCount, unreadOrdersCount }: MobileSidebarProps) {
            ...
            <div className="flex h-20 items-center justify-between px-6 border-b border-slate-800">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-xl leading-tight tracking-wide text-white">buckNet</span>
